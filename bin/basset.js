...
optimist = require('optimist').usage('basset [options] url').demand(1).boolean('h').alias('h', 'help').describe('h', 'This screen').string('n').alias('n', 'num').describe('n', 'Num of repeats')["default"]('n', '1').string('r').alias('r', 'reporter').describe('r', 'Reporter [minimal, full]')["default"]('r', 'minimal').check(function(args) {
